...
class Utf8 extends Register.inherits() {
	...
	*/
	static encode(s) {
		throw new NotImplementedException(null, null, {"fileName": "haxe/Utf8.hx", "lineNumber": 66, "className": "haxe.Utf8", "methodName": "encode"});
	}
	...
	*/
	static decode(s) {
		throw new NotImplementedException(null, null, {"fileName": "haxe/Utf8.hx", "lineNumber": 74, "className": "haxe.Utf8", "methodName": "decode"});
	}
