...
class DateTools {
	...
	public static function days ($n) {
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:207: characters 3-41
	...
	public static function delta ($d, $t) {
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:161: characters 3-40
	...
	public static function format ($d, $f) {
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:148: characters 3-71
	...
	public static function getMonthDays ($d) {
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:172: characters 3-28
		$month = $d->getMonth();
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:173: characters 3-30
		$year = $d->getFullYear();
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:175: lines 175-176
		if ($month !== 1) {
			#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:176: characters 4-31
			return (DateTools::$DAYS_OF_MONTH->arr[$month] ?? null);
		}
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:178: characters 3-73
		$isB = ((($year % 4) === 0) && (($year % 100) !== 0)) || (($year % 400) === 0);
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:179: characters 10-29
		if ($isB) {
			#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:179: characters 19-21
			return 29;
		} else {
			#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:179: characters 27-29
			return 28;
		}
	}
	...
	public static function hours ($n) {
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:200: characters 3-34
	...
	public static function make ($o) {
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:236: characters 3-93
	...
	public static function makeUtc ($year, $month, $day, $hour, $min, $sec) {
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:247: characters 3-74
	...
	public static function minutes ($n) {
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:193: characters 3-27
	...
	public static function parse ($t) {
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:214: characters 3-20
		$s = $t / 1000;
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:215: characters 3-18
		$m = $s / 60;
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:216: characters 3-18
		$h = $m / 60;
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:219: characters 13-28
		$tmp = (int)((fmod($s, 60)));
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:220: characters 13-28
		$tmp1 = (int)((fmod($m, 60)));
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:221: characters 11-26
		$tmp2 = (int)((fmod($h, 24)));
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:217: lines 217-223
	...
	public static function seconds ($n) {
		#/home/runner/haxe/versions/4.2.3/std/DateTools.hx:186: characters 3-20
		return $n * 1000.0;
	}
