...
class Sys {
	...
	public static function args () {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:41: lines 41-45
		if (array_key_exists("argv", $_SERVER)) {
			#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:42: characters 4-89
			return Array_hx::wrap(array_slice($_SERVER["argv"], 1));
		} else {
			#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:44: characters 4-13
			return new Array_hx();
		}
	}
	...
	public static function command ($cmd, $args = null) {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:85: lines 85-95
		if ($args !== null) {
			#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:86: characters 12-24
			if (Sys::systemName() === "Windows") {
				#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:88: lines 88-91
				$_g = new Array_hx();
				#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:89: lines 89-90
				$_g1 = 0;
				$_g2 = (Array_hx::wrap([StringTools::replace($cmd, "/", "\\")]))->concat($args);
				while ($_g1 < $_g2->length) {
					#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:89: characters 12-13
					$a = ($_g2->arr[$_g1] ?? null);
					#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:89: lines 89-90
					++$_g1;
					#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:90: characters 8-37
					$x = SysTools::quoteWinArg($a, true);
					$_g->arr[$_g->length++] = $x;
				}
				#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:88: characters 6-9
				$cmd = $_g->join(" ");
			} else {
				#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:93: characters 12-57
				...
				#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:93: characters 6-9
				$cmd = Array_hx::wrap($result)->join(" ");
			}
		}
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:96: characters 3-30
		$result = Boot::deref(0);
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:97: characters 3-29
		system($cmd, $result);
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:98: characters 3-16
		return $result;
	}
	...
	public static function cpuTime () {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:110: characters 3-54
	...
	public static function environment () {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:125: characters 3-33
		$env = $_SERVER;
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:126: lines 126-128
		$collection = Sys::$customEnvVars;
		foreach ($collection as $key => $value) {
			#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:127: characters 4-21
			$env[$key] = $value;
		}
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:129: characters 3-45
	...
	public static function executablePath () {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:114: characters 10-48
	...
	public static function exit ($code) {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:102: characters 3-20
		exit($code);
	}
	...
	public static function getChar ($echo) {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:148: characters 3-37
		$c = fgetc(STDIN);
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:149: lines 149-155
		if ($c === false) {
			#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:150: characters 4-12
			return 0;
		} else {
			#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:152: lines 152-153
			if ($echo) {
				#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:153: characters 5-19
				echo($c);
			}
			#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:154: characters 4-24
			return ord($c);
		}
	}
	...
	public static function getCwd () {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:67: characters 3-29
		$cwd = getcwd();
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:68: lines 68-69
		if ($cwd === false) {
			#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:69: characters 4-15
			return null;
		}
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:70: characters 3-37
		$l = mb_substr($cwd, -1, null);
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:71: characters 3-61
	...
	public static function getEnv ($s) {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:49: characters 3-32
		$value = getenv($s);
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:50: characters 10-39
		if ($value === false) {
			#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:50: characters 27-31
			return null;
		} else {
			#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:50: characters 34-39
			return $value;
		}
	}
	...
	public static function print ($v) {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:33: characters 3-29
		echo(Std::string($v));
	}
	...
	public static function println ($v) {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:37: characters 3-45
	...
	public static function programPath () {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:121: characters 3-22
	...
	public static function putEnv ($s, $v) {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:54: characters 3-26
		Sys::$customEnvVars[$s] = "" . ($v??'null');
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:55: characters 3-25
	...
	public static function setCwd ($s) {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:75: characters 3-18
		chdir($s);
	}
	...
	public static function setTimeLocale ($loc) {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:63: characters 3-55
	...
	public static function sleep ($seconds) {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:59: characters 10-51
	...
	public static function stderr () {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:143: characters 3-87
		$p = (defined("STDERR") ? STDERR : fopen("php://stderr", "w"));
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:144: characters 3-43
	...
	public static function stdin () {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:133: characters 3-84
		$p = (defined("STDIN") ? STDIN : fopen("php://stdin", "r"));
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:134: characters 3-42
	...
	public static function stdout () {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:138: characters 3-87
		$p = (defined("STDOUT") ? STDOUT : fopen("php://stdout", "w"));
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:139: characters 3-43
		return new FileOutput($p);
	}
	...
	public static function systemName () {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:79: characters 3-33
		$s = php_uname("s");
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:80: characters 3-26
		$p = HxString::indexOf($s, " ");
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:81: characters 10-39
		if ($p >= 0) {
			#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:81: characters 20-34
			return mb_substr($s, 0, $p);
		} else {
			#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:81: characters 37-38
			return $s;
		}
	}
	...
	public static function time () {
		#/home/runner/haxe/versions/4.2.0/std/php/_std/Sys.hx:106: characters 3-32
