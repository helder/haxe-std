...
class Rtti {
	...
	static public function getRtti ($c) {
		#/home/runner/haxe/versions/4.0.0/std/haxe/rtti/Rtti.hx:42: characters 3-41
		$rtti = Reflect::field($c, "__rtti");
		#/home/runner/haxe/versions/4.0.0/std/haxe/rtti/Rtti.hx:43: lines 43-45
		if ($rtti === null) {
			#/home/runner/haxe/versions/4.0.0/std/haxe/rtti/Rtti.hx:44: characters 4-9
			throw new HxException("Class " . (Type::getClassName($c)??'null') . " has no RTTI information, consider adding @:rtti");
		}
		#/home/runner/haxe/versions/4.0.0/std/haxe/rtti/Rtti.hx:46: characters 3-42
		$x = Xml::parse($rtti)->firstElement();
		#/home/runner/haxe/versions/4.0.0/std/haxe/rtti/Rtti.hx:47: characters 3-59
		$infos = (new XmlParser())->processElement($x);
		#/home/runner/haxe/versions/4.0.0/std/haxe/rtti/Rtti.hx:48: lines 48-53
		if ($infos->index === 1) {
			#/home/runner/haxe/versions/4.0.0/std/haxe/rtti/Rtti.hx:49: characters 20-21
			$c1 = $infos->params[0];
			#/home/runner/haxe/versions/4.0.0/std/haxe/rtti/Rtti.hx:50: characters 5-13
			return $c1;
		} else {
			#/home/runner/haxe/versions/4.0.0/std/haxe/rtti/Rtti.hx:51: characters 9-14
			$t = $infos;
			#/home/runner/haxe/versions/4.0.0/std/haxe/rtti/Rtti.hx:52: characters 5-10
	...
	static public function hasRtti ($c) {
		#/home/runner/haxe/versions/4.0.0/std/haxe/rtti/Rtti.hx:62: characters 3-54
