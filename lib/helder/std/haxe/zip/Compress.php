...
class Compress {
	...
	public static function run ($s, $level) {
		#/home/runner/haxe/versions/4.2.1/std/php/_std/haxe/zip/Compress.hx:50: characters 3-54
		$c = \gzcompress($s->toString(), $level);
		#/home/runner/haxe/versions/4.2.1/std/php/_std/haxe/zip/Compress.hx:51: characters 10-35
		$tmp = \strlen($c);
		#/home/runner/haxe/versions/4.2.1/std/php/_std/haxe/zip/Compress.hx:51: characters 3-35
	...
	public function __construct ($level) {
		#/home/runner/haxe/versions/4.2.1/std/php/_std/haxe/zip/Compress.hx:30: characters 3-21
		$this->level = $level;
	}
	...
	public function execute ($src, $srcPos, $dst, $dstPos) {
		#/home/runner/haxe/versions/4.2.1/std/php/_std/haxe/zip/Compress.hx:34: characters 15-51
		$len = $src->length - $srcPos;
		#/home/runner/haxe/versions/4.2.1/std/php/_std/haxe/zip/Compress.hx:34: characters 3-52
		$input = null;
		#/home/runner/haxe/versions/4.2.1/std/php/_std/haxe/zip/Compress.hx:34: characters 15-51
		...
		#/home/runner/haxe/versions/4.2.1/std/php/_std/haxe/zip/Compress.hx:35: characters 3-32
		$data = Compress::run($input, $this->level);
		#/home/runner/haxe/versions/4.2.1/std/php/_std/haxe/zip/Compress.hx:36: characters 3-41
		$len = $data->length;
		...
		#/home/runner/haxe/versions/4.2.1/std/php/_std/haxe/zip/Compress.hx:38: lines 38-42
