...
class Uncompress {
	...
	public static function run ($src, $bufsize = null) {
		#/home/runner/haxe/versions/4.1.1/std/php/_std/haxe/zip/Uncompress.hx:45: characters 3-51
		$c = gzuncompress($src->toString());
		#/home/runner/haxe/versions/4.1.1/std/php/_std/haxe/zip/Uncompress.hx:46: characters 10-35
		$tmp = strlen($c);
		#/home/runner/haxe/versions/4.1.1/std/php/_std/haxe/zip/Uncompress.hx:46: characters 3-35
	...
	public function execute ($src, $srcPos, $dst, $dstPos) {
		#/home/runner/haxe/versions/4.1.1/std/php/_std/haxe/zip/Uncompress.hx:29: characters 15-51
		$len = $src->length - $srcPos;
		#/home/runner/haxe/versions/4.1.1/std/php/_std/haxe/zip/Uncompress.hx:29: characters 3-52
		$input = null;
		#/home/runner/haxe/versions/4.1.1/std/php/_std/haxe/zip/Uncompress.hx:29: characters 15-51
		...
		#/home/runner/haxe/versions/4.1.1/std/php/_std/haxe/zip/Uncompress.hx:30: characters 3-25
		$data = Uncompress::run($input);
		#/home/runner/haxe/versions/4.1.1/std/php/_std/haxe/zip/Uncompress.hx:31: characters 3-41
		$len = $data->length;
		...
		#/home/runner/haxe/versions/4.1.1/std/php/_std/haxe/zip/Uncompress.hx:33: lines 33-37
		return new HxAnon([
			"done" => true,
			"read" => $input->length,
			"write" => $data->length,
