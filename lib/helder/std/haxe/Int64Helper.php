...
class Int64Helper {
	...
	public static function fromFloat ($f) {
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:80: lines 80-82
		if (is_nan($f) || !is_finite($f)) {
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:81: characters 4-9
			throw Exception::thrown("Number is NaN or Infinite");
		}
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:84: characters 3-33
		$noFractions = $f - fmod($f, 1);
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:90: lines 90-92
		if ($noFractions > 9007199254740991) {
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:91: characters 4-9
			throw Exception::thrown("Conversion overflow");
		}
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:93: lines 93-95
		if ($noFractions < -9007199254740991) {
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:94: characters 4-9
			throw Exception::thrown("Conversion underflow");
		}
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:97: characters 16-30
		$this1 = new ___Int64(0, 0);
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:97: characters 3-31
		$result = $this1;
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:98: characters 3-29
		$neg = $noFractions < 0;
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:99: characters 3-47
		$rest = ($neg ? -$noFractions : $noFractions);
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:101: characters 3-13
		$i = 0;
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:102: lines 102-109
		while ($rest >= 1) {
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:103: characters 4-24
			$curr = fmod($rest, 2);
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:104: characters 4-8
			$rest /= 2;
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:105: lines 105-107
			if ($curr >= 1) {
				#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:106: characters 42-56
				$a_high = 0;
				$a_low = 1;
				#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:106: characters 32-60
				$b = $i;
				$b &= 63;
				#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:106: characters 14-61
				$b1 = null;
				#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:106: characters 32-60
				if ($b === 0) {
			...
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:108: characters 4-7
			++$i;
		}
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:111: lines 111-113
		if ($neg) {
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:112: characters 13-30
		...
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:114: characters 3-16
		return $result;
	}
	...
	public static function parseString ($sParam) {
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:37: characters 14-29
		$base_high = 0;
		$base_low = 10;
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:38: characters 17-31
		$this1 = new ___Int64(0, 0);
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:38: characters 3-32
		$current = $this1;
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:39: characters 20-34
		$this1 = new ___Int64(0, 1);
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:39: characters 3-35
		$multiplier = $this1;
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:40: characters 3-27
		$sIsNegative = false;
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:42: characters 3-36
		$s = trim($sParam);
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:43: lines 43-46
		if (mb_substr($s, 0, 1) === "-") {
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:44: characters 4-15
			$sIsNegative = true;
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:45: characters 4-5
			$s = HxString::substring($s, 1, mb_strlen($s));
		}
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:47: characters 3-22
		$len = mb_strlen($s);
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:49: characters 13-17
		$_g = 0;
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:49: characters 17-20
		$_g1 = $len;
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:49: lines 49-72
		while ($_g < $_g1) {
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:49: characters 13-20
			$i = $_g++;
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:50: characters 4-56
			$digitInt = HxString::charCodeAt($s, $len - 1 - $i) - 48;
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:52: lines 52-54
			if (($digitInt < 0) || ($digitInt > 9)) {
				#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:53: characters 5-10
				throw Exception::thrown("NumberFormatError");
			}
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:56: lines 56-69
			if ($digitInt !== 0) {
				#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:57: characters 23-44
				$digit_high = $digitInt >> 31;
				$digit_low = $digitInt;
				#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:58: lines 58-68
				if ($sIsNegative) {
					#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:59: characters 35-63
					$mask = 65535;
					...
					$b_high = $high;
					$b_low = $low;
					#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:59: characters 16-64
					...
					$current = $this1;
					#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:60: lines 60-62
					if (!($current->high < 0)) {
						#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:61: characters 7-12
						throw Exception::thrown("NumberFormatError: Underflow");
					}
				} else {
					#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:64: characters 35-63
					$mask1 = 65535;
					...
					$b_high1 = $high2;
					$b_low1 = $low2;
					#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:64: characters 16-64
					...
					$current = $this2;
					#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:65: lines 65-67
					if ($current->high < 0) {
						#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:66: characters 7-12
						throw Exception::thrown("NumberFormatError: Overflow");
					}
				}
			}
			#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:71: characters 17-44
			$mask2 = 65535;
		...
		#/home/runner/haxe/versions/4.1.2/std/haxe/Int64Helper.hx:73: characters 3-17
		return $current;
	}
}
