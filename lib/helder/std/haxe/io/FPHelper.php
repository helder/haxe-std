...
class FPHelper {
	...
	public static function doubleToI64 ($v) {
		#/home/runner/haxe/versions/4.0.3/std/php/_std/haxe/io/FPHelper.hx:44: characters 3-76
		$a = unpack((FPHelper::$isLittleEndian ? "V2" : "N2"), pack("d", $v));
		#/home/runner/haxe/versions/4.0.3/std/php/_std/haxe/io/FPHelper.hx:45: characters 3-20
		$i64 = FPHelper::$i64tmp;
		#/home/runner/haxe/versions/4.0.3/std/php/_std/haxe/io/FPHelper.hx:46: characters 19-57
		$i64->low = $a[(FPHelper::$isLittleEndian ? 1 : 2)];
		#/home/runner/haxe/versions/4.0.3/std/php/_std/haxe/io/FPHelper.hx:47: characters 19-58
		$i64->high = $a[(FPHelper::$isLittleEndian ? 2 : 1)];
		#/home/runner/haxe/versions/4.0.3/std/php/_std/haxe/io/FPHelper.hx:49: characters 3-13
		return $i64;
	}
	...
	public static function floatToI32 ($f) {
		#/home/runner/haxe/versions/4.0.3/std/php/_std/haxe/io/FPHelper.hx:36: characters 3-52
	...
	public static function i32ToFloat ($i) {
		#/home/runner/haxe/versions/4.0.3/std/php/_std/haxe/io/FPHelper.hx:32: characters 3-52
	...
	public static function i64ToDouble ($low, $high) {
		#/home/runner/haxe/versions/4.0.3/std/php/_std/haxe/io/FPHelper.hx:40: characters 3-108
