...
final class ArrayBufferView_Impl_ {
	...
	public static function _new ($size) {
		#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:60: character 2
	...
	public static function fromBytes ($bytes, $pos = 0, $length = null) {
		#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:89: lines 89-95
		if ($pos === null) {
			$pos = 0;
		}
		#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:90: lines 90-91
		if ($length === null) {
			#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:91: characters 4-31
			$length = $bytes->length - $pos;
		}
		#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:92: lines 92-93
		if (($pos < 0) || ($length < 0) || (($pos + $length) > $bytes->length)) {
			#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:93: characters 4-9
			throw new HxException(Error::OutsideBounds());
		}
		#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:94: characters 10-63
	...
	public static function fromData ($a) {
		#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:86: characters 3-16
		return $a;
	}
	...
	public static function getData ($this1) {
		#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:82: characters 3-14
		return $this1;
	}
	...
	public static function get_buffer ($this1) {
		#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:71: characters 3-20
		return $this1->bytes;
	}
	...
	public static function get_byteLength ($this1) {
		#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:68: characters 3-25
	...
	public static function get_byteOffset ($this1) {
		#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:65: characters 3-25
	...
	public static function sub ($this1, $begin, $length = null) {
		#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:74: characters 10-43
	...
	public static function subarray ($this1, $begin = null, $end = null) {
		#/home/runner/haxe/versions/4.0.3/std/haxe/io/ArrayBufferView.hx:78: characters 10-45
