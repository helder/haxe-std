...
final class EnumFlags_Impl_ {
	...
	public static function _new ($i = 0) {
		#/home/runner/haxe/versions/4.1.0/std/haxe/EnumFlags.hx:39: character 2
		if ($i === null) {
			$i = 0;
		}
		$this1 = $i;
	...
	public static function has ($this1, $v) {
		#/home/runner/haxe/versions/4.1.0/std/haxe/EnumFlags.hx:52: characters 3-46
	...
	public static function ofInt ($i) {
		#/home/runner/haxe/versions/4.1.0/std/haxe/EnumFlags.hx:84: characters 10-29
		$i1 = $i;
		#/home/runner/haxe/versions/4.1.0/std/haxe/EnumFlags.hx:84: characters 27-28
		if ($i1 === null) {
			$i1 = 0;
		}
		#/home/runner/haxe/versions/4.1.0/std/haxe/EnumFlags.hx:84: characters 10-29
	...
	public static function set ($this1, $v) {
		#/home/runner/haxe/versions/4.1.0/std/haxe/EnumFlags.hx:64: characters 3-33
		$this1 |= 1 << $v->index;
	}
	...
	public static function toInt ($this1) {
		#/home/runner/haxe/versions/4.1.0/std/haxe/EnumFlags.hx:92: characters 3-14
		return $this1;
	}
	...
	public static function unset ($this1, $v) {
		#/home/runner/haxe/versions/4.1.0/std/haxe/EnumFlags.hx:76: characters 3-48
		$this1 &= -1 - (1 << $v->index);
	}
}
