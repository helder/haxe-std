...
final class NodeListAccess_Impl_ {
	...
	public static function resolve ($this1, $name) {
		#/home/runner/haxe/versions/4.0.5/std/haxe/xml/Access.hx:76: characters 3-14
		$l = new Array_hx();
		#/home/runner/haxe/versions/4.0.5/std/haxe/xml/Access.hx:77: characters 13-37
		$x = $this1->elementsNamed($name);
		while ($x->hasNext()) {
			#/home/runner/haxe/versions/4.0.5/std/haxe/xml/Access.hx:77: lines 77-78
			$x1 = $x->next();
			#/home/runner/haxe/versions/4.0.5/std/haxe/xml/Access.hx:78: characters 11-24
			...
			$this2 = $x1;
			#/home/runner/haxe/versions/4.0.5/std/haxe/xml/Access.hx:78: characters 4-25
			$l->arr[$l->length] = $this2;
			++$l->length;
		}

		#/home/runner/haxe/versions/4.0.5/std/haxe/xml/Access.hx:79: characters 3-11
		return $l;
	}
}
