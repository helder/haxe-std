...
final class NodeAccess_Impl_ {
	...
	public static function resolve ($this1, $name) {
		#/home/runner/haxe/versions/4.2.0/std/haxe/xml/Access.hx:28: characters 3-43
		$x = $this1->elementsNamed($name)->next();
		#/home/runner/haxe/versions/4.2.0/std/haxe/xml/Access.hx:29: lines 29-32
		if ($x === null) {
			#/home/runner/haxe/versions/4.2.0/std/haxe/xml/Access.hx:30: characters 4-81
			$xname = null;
			#/home/runner/haxe/versions/4.2.0/std/haxe/xml/Access.hx:30: characters 16-80
			if ($this1->nodeType === Xml::$Document) {
				#/home/runner/haxe/versions/4.2.0/std/haxe/xml/Access.hx:30: characters 4-81
				$xname = "Document";
			} else {
				#/home/runner/haxe/versions/4.2.0/std/haxe/xml/Access.hx:30: characters 67-80
			...
			#/home/runner/haxe/versions/4.2.0/std/haxe/xml/Access.hx:31: characters 4-9
			throw Exception::thrown(($xname??'null') . " is missing element " . ($name??'null'));
		}
		#/home/runner/haxe/versions/4.2.0/std/haxe/xml/Access.hx:33: characters 10-23
