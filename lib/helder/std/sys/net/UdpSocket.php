...
class UdpSocket extends Socket {
	...
	public function __construct () {
		#/home/runner/haxe/versions/4.1.1/std/sys/net/UdpSocket.hx:30: characters 3-8
	...
	public function readFrom ($buf, $pos, $len, $addr) {
		#/home/runner/haxe/versions/4.1.1/std/sys/net/UdpSocket.hx:52: characters 3-11
		return 0;
	}
	...
	public function sendTo ($buf, $pos, $len, $addr) {
		#/home/runner/haxe/versions/4.1.1/std/sys/net/UdpSocket.hx:45: characters 3-11
		return 0;
	}
	...
	public function setBroadcast ($b) {
		#/home/runner/haxe/versions/4.1.1/std/sys/net/UdpSocket.hx:38: characters 3-8
		throw Exception::thrown("Not available on this platform");
	}
}
