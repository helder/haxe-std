...
class File {
	...
	public static function append ($path, $binary = true) {
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:56: characters 3-66
		if ($binary === null) {
			$binary = true;
		}
	...
	public static function copy ($srcPath, $dstPath) {
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:67: characters 3-32
	...
	public static function getBytes ($path) {
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:34: characters 10-57
	...
	public static function getContent ($path) {
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:30: characters 3-33
	...
	public static function read ($path, $binary = true) {
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:48: characters 3-73
		if ($binary === null) {
			$binary = true;
		}
	...
	public static function saveBytes ($path, $bytes) {
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:42: characters 3-23
		$f = File::write($path);
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:43: characters 3-17
		$f->write($bytes);
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:44: characters 3-12
		$f->close();
	}
	...
	public static function saveContent ($path, $content) {
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:38: characters 3-35
	...
	public static function update ($path, $binary = true) {
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:59: lines 59-64
		if ($binary === null) {
			$binary = true;
		}
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:60: characters 8-31
		\clearstatcache(true, $path);
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:60: lines 60-62
		if (!\file_exists($path)) {
			#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:61: characters 4-23
			File::write($path)->close();
		}
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:63: characters 3-68
	...
	public static function write ($path, $binary = true) {
		#/home/runner/haxe/versions/4.1.5/std/php/_std/sys/io/File.hx:52: characters 3-66
		if ($binary === null) {
			$binary = true;
		}
