...
final class ProcessPipes_Impl_ {
	...
	public static function get_stderr ($this1) {
		#/home/runner/haxe/versions/4.1.4/std/php/_std/sys/io/Process.hx:45: characters 3-17
		return $this1[2];
	}
	...
	public static function get_stdin ($this1) {
		#/home/runner/haxe/versions/4.1.4/std/php/_std/sys/io/Process.hx:39: characters 3-17
		return $this1[0];
	}
	...
	public static function get_stdout ($this1) {
		#/home/runner/haxe/versions/4.1.4/std/php/_std/sys/io/Process.hx:42: characters 3-17
		return $this1[1];
	}
}
