...
final class NativeStructArray_Impl_ {
	...
	public static function __fromObject ($obj) {
		#/home/runner/haxe/versions/4.2.3/std/php/NativeStructArray.hx:34: characters 3-32
		return ((array)($obj));
	}
	...
	public static function __toObject ($this1) {
		#/home/runner/haxe/versions/4.2.3/std/php/NativeStructArray.hx:39: characters 3-31
	...
	public static function get ($this1, $key) {
		#/home/runner/haxe/versions/4.2.3/std/php/NativeStructArray.hx:44: characters 3-19
		return $this1[$key];
	}
	...
	public static function set ($this1, $key, $val) {
		#/home/runner/haxe/versions/4.2.3/std/php/NativeStructArray.hx:48: characters 3-25
